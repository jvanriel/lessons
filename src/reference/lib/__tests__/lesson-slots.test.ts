...
describe("formatDateNl", () => {
  it("formats January date", () => {
    expect(formatDateNl("2026-01-15")).toBe("15 januari 2026");
  });
  ...
  it("formats December date", () => {
    expect(formatDateNl("2026-12-25")).toBe("25 december 2026");
  });

  it("handles single-digit day", () => {
    expect(formatDateNl("2026-06-01")).toBe("1 juni 2026");
  });
});
...
describe("buildIcs", () => {
  const baseParams = {
    ...
    startTime: "10:00",
    endTime: "11:00",
    summary: "Golfles met Dummy Pro",
    location: "Golfclub Nuclea",
  ...
  it("has correct UID", () => {
    const ics = buildIcs(baseParams);
    expect(ics).toContain("UID:booking-999@silverswing.golf");
  });

  it("includes summary and location", () => {
    const ics = buildIcs(baseParams);
    expect(ics).toContain("SUMMARY:Golfles met Dummy Pro");
    expect(ics).toContain("LOCATION:Golfclub Nuclea");
  });
...
describe("buildCancelIcs", () => {
  const baseParams = {
    ...
    summary: "Golfles met Dummy Pro",
    location: "Golfclub Nuclea",
    description: "Geannuleerd: golfles bij Dummy Pro",
    bookingId: 999,
  };
