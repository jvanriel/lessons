...
const sections: NavSection[] = [
  ...
  // "My Lessons" section parked during closed beta — the student-facing
  // dashboard + bookings list are not exposed in nav. Routes still work
  // for anyone who arrives via email link or QR code.
  {
    label: "Admin",
    role: "admin",
    items: [
