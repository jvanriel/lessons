...
/**
 * Tabbed dialog for the pro side — shows both pro view and student view.
 */
export function TabbedExplanationDialog({
  proData,
  studentData,
  onClose,
}: {
  ...
  const data = tab === "pro" ? proData : studentData;
    ...
    >
      <div className="w-full max-w-md rounded-xl border border-green-200 bg-white shadow-2xl">
        ...
        <div className="max-h-[55vh] overflow-y-auto px-5 py-4 space-y-4">
          ...
          {/* Preferred day (student tab only) */}
          {tab === "student" && studentData.preferredDay && (
            <div className="flex items-center gap-2 rounded-lg bg-green-50 px-3 py-2 text-xs text-green-700">
              <svg className="h-3.5 w-3.5 shrink-0 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5" />
              </svg>
